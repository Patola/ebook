...
image::deltagiganteehangprinter.png[deltagiganteehangprinter,width=642,height=409,align="center",title="Processo de calibração de uma delta (Rostock) usando uma caneta para achar o problema. https://www.youtube.com/watch?v=gPvIHsF13D4"]
