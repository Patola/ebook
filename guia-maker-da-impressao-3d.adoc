...
=== Extrusor + O extrusor é o conjunto que puxa (traciona) o filamento plástico e o
...
=== Não acabou: elementos para aferição da temperatura!
...
* *Mesa com resistências* +
Foram as primeiras a surgir. Resistências simples são elementos aquecedores fáceis de
...
* *Fitas* +
São colocadas sobre a mesa ou o vidro usualmente por toda sua área, com as tiras em paralelo
