...
| Aberta | image:image61.png[image,width=141,height=189] | É possível alcançar
a peça impressa diretamente.
| Fechada | image:image62.png[image,width=158,height=158] | A peça
fica em uma câmara interna.
|====
...
__CoreXZ__, etc.). ⁴
* *Carro X estilo Mendel i2* + Se por um lado os sistemas de cinemática paralela como
...
(1.040 kg).
* *Mesa com movimento linear horizontal* + Usada nas _Prusa_ como eixo Y, o movimento horizontal,
...
+ [[FEITO_Polias_e_correias]]São estruturas usadas em sistemas de engrenagens e
* *Extrusões ou perfis de
...
* **Rolamentos + **Rolamentos (__bearings__ em
...
* *Buchas* + Buchas são peças de material deslizante – geralmente
...
acoplados
* image:image82.png[image,width=215,height=185]bowden – tracionador e hotend separados
...
adicionais
* image:image85.jpeg[image,width=203,height=152]**direct drive** – o pinhão traciona
...
e isolante.
* image:image88.jpeg[image,width=211,height=157]**de metal com PTFE interno** *
...
* **Como é removível e barato, permite a substituição
...
* *PLA e ABS, ou majoritariamente ABS, e peças
...
* *Pinos de saída para dispositivos
...
* *Pinos de conexão dos motores muito estreitos*
...
restrições”.
* De particular interesse ainda são: ** A resolução RDC 17/08 - *aditivos* para materiais
...
* *Base de dados pública de protocolos*
...
* *Exaustor / ventilador*
– para ajudar a remover ou arejar os vapores químicos, solventes e nanopartículas; evitar ar parado.
* *Óculos
...
* *Luvas de nitrilo descartáveis* – as
...
para descarte¹. As luvas de látex comuns são mais baratas mas oferecem maior risco.
* *Jaleco* ou *Macacão
...
* *Escovas de aço (e outros metais)* – são instrumentos
...
* *Gotejador de cera* – Esse nome estranho – em inglês, _wax
...
* O acabamento químico deixa a superfície “lisa” e vedada, e *prejudica a
...
* Baixo preço.
* Bastante volátil, o que faz com que a peça
...
* Inflamável.
* Não raramente interage
com corantes do plástico e os “desbota”.
* Levemente tóxica.
...
* Alta disponibilidade em lojas de laboratório.
* Baixo preço.
* Moderadamente volátil, a peça não demora
muito para secar.
* Consegue tratar vários plásticos diferentes.
* Ação forte e rápida, alguns segundos
podem ser suficientes de acordo com a peça.
* Não é inflamável.
...
* Necessidade de permissão da polícia federal e limite
de 2l por mês.
...
1.  [[tetraidrofurano]] === Tetraidrofurano
...
* Relativa baixa toxicidade, semelhante à da acetona. Seu odor pungente e forte também torna vazamentos facilmente perceptíveis, bem mais que as outras substâncias.
...
* Preço semelhante ao de frascos
de acetona e metil-etil-cetona.
* Mistura dos dois solventes, se valendo tanto da força maior da MEK quanto da
volatilidade da acetona.

*Desvantagens:*

* Só funciona com os mesmos plásticos da acetona e metil-etil-cetona.
* Tem os mesmos perigos e riscos dos
dois solventes.
...
* *Thinner:* Thinner, ou “diluente” em português, é um composto que serve
...
* Utiliza uma grande quantidade de solvente, o que além de dispendioso
torna seu uso crítico visto que têm limites mensais regulados pela lei.
* Lida com pressões mecânicas
de convecção e efeitos de flutuação que podem distorcer a peça.
* Em muitos casos atinge os corantes e
...
* Maior controle, por ter
ação mais lenta.

*Desvantagens:*

* Necessita de testes caso a caso, pois a água pode degradar o material.
* Lida com pressões mecânicas de
convecção e efeitos de flutuação.
* Precisa que o solvente seja miscível com água, descartando clorofórmio
...
* Talento nessa forma de artesanato vai pesar bastante na
forma final da aplicação.
* É útil para outros usos, como colar peças do mesmo plástico.
* Utiliza pouco
solvente – somente o essencial para umedecer a superfície com o aplicador.
* Baixa exposição ao solvente,
...
* Se forem usados
pincéis, eles terão vida curta e necessitarão ser constantemente trocados.
* Com seringas e borrifadores, o
solvente aplicado pode não ter o efeito desejado.
* Depende de o aplicador alcançar a parte da peça que precisa
...
* É
um método lento, permitindo por isso maior controle.
* Não envolve aquecimento ou fonte de energia, oferecendo
por isso menos riscos.
...
* Coloca-se uma *base* para que a peça *não entre em contato com o
líquido* (caso contrário ela sofrerá deformação quase imediata), e que tenha **pequena área de contato**,
como uma rede metálica.
* Derrama-se um pouco de solvente no recipiente – geralmente *1 a 2mm de nível de
líquido* são suficientes para durar por uns 5 minutos – e por fim se **coloca a peça**.
* Pode-se colocar
...
* Antes de chegar ao ponto desejado, *desliga-se
...
* Solução pronta
e simples, sendo apenas necessário a compra do insumo (solvente) e manutenção preventiva.
* Necessidade muito
...
* Fragilidade das soluções, em um mercado ainda
incipiente.
...
mais de 150 dólares.
* Existem vários tipos de “canetas” de aerógrafo, citadas nas referências³. Para
...
deslocamentos compensados com A em 0 + M500 ; grava na EEPROM/config
* Mandamos o hotend novamente para as três
...
tocou a mesa ** G28 + G1 X0 Y75 Z0.2 ; continua acima da mesa + G1 X0 Y75 Z0 ; tocou a mesa.
* O hotend deve ter
...
o hotend encostou na mesa. Calibramos DELTA_RADIUS!
...
* Ele calcula quase todas as variáveis
...
* *V__número__* – modo de execução: ** *V0* – Modo _dry-run_
...
* Finalizada a impressão, há uma etapa de **retirada da
impressão da mesa**, que pode dar algum trabalho;
* Retirada a peça, pode haver a necessidade de **remoção de
estruturas de apoio**, como a bainha, os suportes, o raft;
...
camada ele calcula que gastará 15 mm³ de plástico e você põe o multiplicador de extrusão em 1.1; 15
* 1.1 =
...
* Na aba *Models* temos o “**Automatically scale to correct unit system
...
* Velocidade de primeira camada:
20%
* Velocidade de travel: 100 mm/s
* Velocidade de infill: 70 mm/s
* Velocidade de pontes: 80 mm/s
* Velocidade
de _overhangs_ (somente no software repsnapper): 20 mm/s
* Aceleração: 1000 mm/s² nos eixos X e Y, 3000 mm/s²
para as impressoras 3D mais robustas, especialmente CoreXY e semelhantes.
* Jerk X/Y: 20 mm/s
* É importantíssimo
...
* O Simplify3D tem as configurações bastante organizadas, e as de retração não
...
* _*Alternate Extra Wall*_ faz em camadas alternadas a parede
...
* *Embolamento do filamento nos vãos
...
manter a pressão interna mais constante; um valor entre 200 e 500 mm/s² é recomendado.
* *Retração* deve ser
...
* *Bipolar*
(motor) – motor elétrico com apenas dois pólos em seu campo estacionário, usado em impressoras 3D.
* *Blob*
...
* *Dissipação passiva* – quando
o componente usa somente a geometria e material para dissipar o calor.
...
* *Escaneamento
3D* – o mesmo que __digitalização 3D__.
...
* *Lost PLA casting*
– o processo de cera perdida, mas executado com peças de PLA no lugar da cera.
* *Lost wax casting* – ver
_cera perdida._
...
* *Malha* ** *Aberta e Fechada (controle)*
...
* *NC* ** *Non-Commercial* – no âmbito de
...
– motor descrito pelos padrões NEMA com 1,7×1,7 polegadas.
...
* *Poliacetal* –
__polixoximetileno (POM). Ver Delrin__.
...
* *Ponte* – Estrutura impressa que liga duas
ilhas sem suporte.
...
* *Prototipagem rápida*
– conjunto de técnicas para fabricação rápida de uma peça usando modelagem 3D e impressoras 3D.
* *Prusa*
...
* *PVAc* –
acetato de polivinila, a substância-base da cola branca escolar e cola de madeira.
...
* *Sailfish*
– firmware open-source usado em impressoras estilo _Makerbot_ (hoje em dia, os clones).
* *Sanguinololu*
...
* *Skeinforge*
– antiga suite de utilitários fatiadores em python, usada para CNC e impressão 3D.
* *Skirt* – “saia”,
...
* *SLA/DLP*
– modificação da estereolitografia usando um projetor (DLP) ao invés dos galvos.
* *Slic3r* – fatiador
...
* *Trilho* – elemento deslizante por onde o _patim_
se move.
...
textos escritos.
* https://www.youtube.com/makerlinux[_https://www.youtube.com/makerlinux_]
